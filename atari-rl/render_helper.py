...
class Renderer(object):
  ...
  imported_meta = tf.train.import_meta_graph("runs/breakout/run_5/model.ckpt-27005.meta")  
  #env = gym.make("Brekaout-v0")
  with tf.Session() as session:
    imported_meta.restore(session,tf.train.latest_checkpoint("runs/breakout/run_5"))
