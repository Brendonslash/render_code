...
from render_helper import Renderer
...
flags.DEFINE_integer('num_steps', 5000000, 'Number of steps to train on')
flags.DEFINE_integer(
...
def main(_):
  ...
  if config.profile:
    ...
    profile.runctx('rend.train()', globals(), locals(), 'main.prof')
  else:
    rend.train()
